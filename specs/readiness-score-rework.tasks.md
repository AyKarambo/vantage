...
- [x] **A1 — Tuning constants + stat helpers**
...
- [x] **A3 — Objective-performance subscore + dampener**
...
- [x] **A5 — Composite score, band derivation & state (the engine swap)**
...
- [x] **A6 — Orchestrator, confidence, signals, trend**
...
- [x] **B1 — Call-site wiring + launch-toast fix**
...
- [x] **B2 — Performance-rating analytics rollups (issue #44 part 1, core)**
...
- [x] **B3 — Sample-data performance backfill + sanity harness**
...
- [x] **C1 — Readiness screen: subscore breakdown + methodology modal**
...
- [x] **C3 — Trends: performance card + correlation tiles**
...
- [x] **C4 — Heroes & Maps rating columns**
...
- [x] **D2 — Definition-of-Done verification**
