...
export const ARTICLES: WikiArticle[] = [
...

  {
    ...
    plain: () => h('div', null,
      wikiPara('The trend chart shows your readiness over the last three weeks. Higher is fresher; the faint columns behind the line are how many games you played each day, and a hollow dot marks a day you didn’t play — the score still moves on a rest day, just from recovery rather than a result.'),
      wikiPara('The dashed lines mark the same fresh (70+) and loaded (below 40) cuts the colour bands use.'),
    ),
    howItWorks: () => h('div', null,
